 ...
 * to keep the client code as consistent as possible, we ensure that the field
 * names in DataRowLite match the corresponding names in DataRow. As with
 * DataRow, we plan to convert DataRowLite objects to JSON, so we need to make
 * their fields public.
 */
